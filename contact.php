                                ...
                                <h1 class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">Give Feedback</h1>
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" name="name" class="form-control" id="name" placeholder="Your Name" value="<?php echo "$userName"?>" readonly>
                                            <label for="name">Your Name</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="email" name="email" class="form-control" id="email" placeholder="Your Email" value="<?php echo "$userEmail"?>" readonly>
                                    ...
                                    <div class="col-12">
                                        <button class="btn btn-primary w-100 py-3" name="submit" value="Send" type="submit">Send Message</button>
                                    </div>
                                </div>
                            </form>
                        </div>
